package com.rubendal.kuroganehammercom.rivals.adapter;
...
public class CharacterAdapter extends BaseAdapter {
    ...
    private List<RivalsCharacter> list;
    private int x;

    public CharacterAdapter(Context context, List<RivalsCharacter> list, int x)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        RivalsCharacter character = list.get(position);

        if(convertView == null){
            convertView =  LayoutInflater.from(context).inflate(R.layout.rivals_character_grid_layout, parent, false);
        }
        ...
        img.getLayoutParams().height = x * 5 / 14;
