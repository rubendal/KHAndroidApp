...
import com.rubendal.kuroganehammercom.ultimate.asynctask.CharacterDataAsyncTask;
...
public class SSBUCharacterDataFragment extends KHFragment {

    private SSBUCharacterData data;

    public SSBUCharacterDataFragment() {
    }
    ...
    public static SSBUCharacterDataFragment newInstance(SSBUCharacterData data){
        SSBUCharacterDataFragment fragment = new SSBUCharacterDataFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(getArguments() != null){
            this.data = (SSBUCharacterData)getArguments().getSerializable("data");
        }
