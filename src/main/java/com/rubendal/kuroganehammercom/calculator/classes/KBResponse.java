...
public class KBResponse implements Serializable {
    ...
    public Integer attacker_hitlag, target_hitlag, paralysis_time, hitstun, hitstun_faf, airdodge_hitstun_cancel, aerial_hitstun_cancel, hit_advantage, shield_hitlag, shield_stun, shield_advantage, flower_time;
    ...
    public KBResponse(){
        ...
        rage = 1f;
        attacker_hitlag = target_hitlag = paralysis_time = hitstun_faf = hitstun = aerial_hitstun_cancel = airdodge_hitstun_cancel = hit_advantage = shield_advantage = shield_hitlag = shield_stun = flower_time = 0;
