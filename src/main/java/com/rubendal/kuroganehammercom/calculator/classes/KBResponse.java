...
public class KBResponse implements Serializable {
    ...
    public Integer attacker_hitlag, target_hitlag, paralysis_time, hitstun, hitstun_faf, airdodge_hitstun_cancel, aerial_hitstun_cancel, shield_hitlag, shield_stun, shield_advantage;
    public boolean can_jab_lock, reeling, unblockable;

    public KBResponse(){
        damage = launch_angle = kb = lsi = launch_speed = horizontal_launch_speed = vertical_launch_speed = gravity_boost = rage = 0f;
        attacker_hitlag = target_hitlag = paralysis_time = hitstun_faf = hitstun = aerial_hitstun_cancel = airdodge_hitstun_cancel = shield_advantage = shield_hitlag = shield_stun = 0;
