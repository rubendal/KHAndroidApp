package com.rubendal.kuroganehammercom.dbfz.adapter;
...
public class CharacterAdapter extends BaseAdapter {
    ...
    private List<DBCharacter> list;
    private int x;

    public CharacterAdapter(Context context, List<DBCharacter> list, int x)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        DBCharacter character = list.get(position);

        if(convertView == null){
            convertView =  LayoutInflater.from(context).inflate(R.layout.db_character_grid_layout, parent, false);
        }
